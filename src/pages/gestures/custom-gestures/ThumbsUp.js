...
thumbsUpGesture.addDirection(Finger.Thumb, FingerDirection.DiagonalUpLeft, 1.0);
thumbsUpGesture.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 1.0);
